...
var useViewportSize = (function () {
  ...
  var setSizeHandler = useCallback(function () {
...
var useAsync = (function (asyncFunction, options) {
  ...
  var executeAsync = useCallback( /*#__PURE__*/function () {
...
export { useAsync, useBool, useEventListener, useIsDomReady, useViewportSize };
